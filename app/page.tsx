            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <h1 className="text-4xl lg:text-6xl font-bold leading-tight">
                  Gestión Inteligente
                  <span className="block text-teal-300">Municipal</span>
                </h1>
                  ...
                  <div className="relative bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20">
                    <div className="grid grid-cols-2 gap-4">
                      <div className="bg-white/20 rounded-xl p-4">
                        ...
                        <div className="text-teal-100 text-sm">Gestión integral</div>
                      </div>
                      <div className="bg-white/20 rounded-xl p-4">
                        <div className="text-3xl font-bold">24/7</div>
                        <div className="text-teal-100 text-sm">Acceso disponible</div>
                      </div>
                      <div className="bg-white/20 rounded-xl p-4">
                        <div className="text-3xl font-bold">100%</div>
                        <div className="text-teal-100 text-sm">Datos seguros</div>
                      </div>
                      <div className="bg-white/20 rounded-xl p-4">
                        <div className="text-3xl font-bold">0</div>
                        <div className="text-teal-100 text-sm">Complejidad</div>
                      </div>
                    </div>
                  </div>
                </div>
